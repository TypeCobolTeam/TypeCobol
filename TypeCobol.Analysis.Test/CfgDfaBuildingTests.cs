...
namespace TypeCobol.Analysis.Test
{
    ...
    public class CfgDfaBuildTests
    {
        ...
        public void ExecSqlOutsideProc()
        {
            ...
            try
            {
                IList<ControlFlowGraph<Node, DfaBasicBlockInfo<Symbol>>> cfg = CfgTestUtils.ParseCompareDiagnostics< DfaBasicBlockInfo<Symbol> >(analyzerForDfaProvider, cfg_identifier, path);
        ...
        public void PrgWithNoProcDiv()
        {
            ...
            string expectedPath = Path.Combine(Directory.GetCurrentDirectory(), "CfgDfaBuildTests", "EmptyCfg.dot");
            CfgTestUtils.GenDotCfgAndCompare(cfg[0], path, expectedPath, true);
