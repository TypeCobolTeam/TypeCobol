...
{ 
    ...
    SKIP3,
    TITLE,
    COMPILERDIRECTIVE_CALLINT,
    COMPILERDIRECTIVE_CALLINTERFACE,
    COMPILERDIRECTIVE_DATA,
    COMPILERDIRECTIVE_DEFINE,
    COMPILERDIRECTIVE_ELSE,
    COMPILERDIRECTIVE_END_EVALUATE,
    COMPILERDIRECTIVE_END_IF,
    COMPILERDIRECTIVE_EVALUATE,
    COMPILERDIRECTIVE_IF,
    COMPILERDIRECTIVE_INLINE,
    COMPILERDIRECTIVE_WHEN,
	...
	QUESTION_MARK,
	COMPILER_DIRECTIVE,
	COPY_IMPORT_DIRECTIVE,
	REPLACE_DIRECTIVE,
	CONTINUATION_TOKEN_GROUP,
	// Formalised Comments
	FORMALIZED_COMMENTS_START,
	FORMALIZED_COMMENTS_STOP,
