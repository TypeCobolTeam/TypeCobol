...
//TODO SQL_MERGE is missing from the lexer token set; other SQL statement-starting
// keywords may also be missing. Adding new keywords should be addressed in a
// separate issue.
