    ...
    public static class TypeCobolOptionSet
    {
        public static OptionSet GetCommonTypeCobolOptions(TypeCobolConfiguration typeCobolConfig)
        {
            var commonOptions = new OptionSet() {
                ...
                { "cea|checkendalignment=", "Check if a End statement is aligned with the matching opening statement.", v => typeCobolConfig.CheckEndAlignment = !(string.IsNullOrEmpty(v) == false && v.ToLower() == "false") },
            };
