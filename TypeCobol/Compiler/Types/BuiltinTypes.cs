...
namespace TypeCobol.Compiler.Types
{
    ...
    public class BuiltinTypes
    {
        ...
        public static readonly Type UsageNoType = new Type(Tags.Usage, UsageFormat.None);
        public static readonly Type UsageCompType = new Type(Tags.Usage, UsageFormat.Comp);
        public static readonly Type UsageComp4Type = new Type(Tags.Usage, UsageFormat.Comp4);
        public static readonly Type UsageComp5Type = new Type(Tags.Usage, UsageFormat.Comp5);
        public static readonly Type UsageDisplay1Type = new Type(Tags.Usage, UsageFormat.Display1);
        public static readonly Type UsageNationalType = new Type(Tags.Usage, UsageFormat.National);
        public static readonly Type UsageBinaryType = new Type(Tags.Usage, UsageFormat.Binary);
        public static readonly Type UsageComp1Type = new Type(Tags.Usage, UsageFormat.Comp1);
        public static readonly Type UsageFunctionPointerType = new Type(Tags.Usage, UsageFormat.FunctionPointer);
        public static readonly Type UsageObjectReferenceType = new Type(Tags.Usage, UsageFormat.ObjectReference);
        public static readonly Type UsageIndexType = new Type(Tags.Usage, UsageFormat.Index);
        public static readonly Type UsagePointerType = new Type(Tags.Usage, UsageFormat.Pointer);
        public static readonly Type UsageComp2Type = new Type(Tags.Usage, UsageFormat.Comp2);
        public static readonly Type UsageDisplayType = new Type(Tags.Usage, UsageFormat.Display);
        public static readonly Type UsagePackedDecimalType = new Type(Tags.Usage, UsageFormat.PackedDecimal);
        public static readonly Type UsageProcedurePointerType = new Type(Tags.Usage, UsageFormat.ProcedurePointer);
        public static readonly Type UsageComp3Type = new Type(Tags.Usage, UsageFormat.Comp3);
        #endregion
