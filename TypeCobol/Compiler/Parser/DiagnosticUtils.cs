...
namespace TypeCobol.Compiler.Parser
{
    ...
    public static class DiagnosticPositionHelper
    {
        ...
        public static Diagnostic.Position Position(this Token token)
        {
            ...
            return new Diagnostic.Position(token.Line, token.Column, token.Line, token.EndColumn, copyDirective);
        }
        ...
        public static Diagnostic.Position Position(this CodeElement codeElement)
        {
            ...
            return new Diagnostic.Position(codeElement.Line, codeElement.StartIndex + 1, codeElement.LineEnd, codeElement.StopIndex + 1, copyDirective);
        }
    }
}
