...
namespace TypeCobol.Compiler.Directives
{
    ...
    public class IBMCompilerOptions
    {
        ...
        /// </summary>
        public void CopyIBMOptionsTo(IBMCompilerOptions otherOptions)
        {            
            otherOptions.ADATA = ADATA;
            otherOptions.ADV = ADV;
            otherOptions.AFP = AFP;
            otherOptions.ARCH = ARCH;
            otherOptions.ARITH = ARITH;
            otherOptions.AWO = AWO;
            otherOptions.BLOCK0 = BLOCK0;
            otherOptions.BUFSIZE = BUFSIZE;
            otherOptions.CICS = CICS;
            otherOptions.CODEPAGE = CODEPAGE;
            otherOptions.COMPILE = COMPILE;
            otherOptions.CURRENCY = CURRENCY;
            otherOptions.DATA = DATA;
            otherOptions.DBCS = DBCS;
            otherOptions.DECK = DECK;
            otherOptions.DIAGTRUNC = DIAGTRUNC;
            otherOptions.DISPSIGN = DISPSIGN;
            otherOptions.DLL = DLL;
            otherOptions.DUMP = DUMP;
            otherOptions.DYNAM = DYNAM;
            otherOptions.EXIT = EXIT;
            otherOptions.EXPORTALL = EXPORTALL;
            otherOptions.FASTSRT = FASTSRT;
            otherOptions.FLAG = FLAG;
            otherOptions.FLAGSTD = FLAGSTD;
            otherOptions.HGPR = HGPR;
            otherOptions.INTDATE = INTDATE;
            otherOptions.LANGUAGE = LANGUAGE;
            otherOptions.LINECOUNT = LINECOUNT;
            otherOptions.LIST = LIST;
            otherOptions.MAP = MAP;
            otherOptions.MAXPCF = MAXPCF;
            otherOptions.MDECK = MDECK;
            otherOptions.NAME = NAME;
            otherOptions.NSYMBOL = NSYMBOL;
            otherOptions.NUMBER = NUMBER;
            otherOptions.NUMPROC = NUMPROC;
            otherOptions.OBJECT = OBJECT;
            otherOptions.OFFSET = OFFSET;
            otherOptions.OPTFILE = OPTFILE;
            otherOptions.OPTIMIZE = OPTIMIZE;
            otherOptions.OUTDD = OUTDD;
            otherOptions.PGMNAME = PGMNAME;
            otherOptions.QUOTE = QUOTE;
            otherOptions.RENT = RENT;
            otherOptions.RMODE = RMODE;
            otherOptions.SEQUENCE = SEQUENCE;
            otherOptions.SIZE = SIZE;
            otherOptions.SOURCE = SOURCE;
            otherOptions.SPACE = SPACE;
            otherOptions.SQL = SQL;
            otherOptions.SQLCCSID = SQLCCSID;
            otherOptions.SQLIMS = SQLIMS;
            otherOptions.SSRANGE = SSRANGE;
            otherOptions.STGOPT = STGOPT;
            otherOptions.TERMINAL = TERMINAL;
            otherOptions.TEST = TEST;
            otherOptions.THREAD = THREAD;
            otherOptions.TRUNC = TRUNC;
            otherOptions.VBREF = VBREF;
            otherOptions.WORD = WORD;
            otherOptions.XREF = XREF;
            otherOptions.ZWB = ZWB;
        }
