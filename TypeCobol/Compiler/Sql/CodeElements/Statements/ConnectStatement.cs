...
namespace TypeCobol.Compiler.Sql.CodeElements.Statements
{
    public class ConnectStatement : SqlStatementElement
    {
        ...
        public ConnectStatement(ConnectionAuthorization authorization, SyntaxProperty<bool> reset, ConnectionTarget target) : base(CodeElementType.ConnectStatement, StatementType.ConnectStatement)
        {
