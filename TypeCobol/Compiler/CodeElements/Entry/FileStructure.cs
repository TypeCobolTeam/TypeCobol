...
namespace TypeCobol.Compiler.CodeElements
{
    ...
    public class FileStructure
    {
        ...
        /// </summary>
        public FileRecordsOrganization RecordsOrganization { get; set; }
    }
    ...
    {
        public SequentialFileStructure()
        {
        ...
        /// </summary>
        public LiteralOrSymbolReference<string,DataName> PaddingCharacter { get; set; }
        ...
        /// </summary>
        public SymbolReference<DataName> Password { get; set; }
    }
    ...
    public class IndexedFileStructure : FileStructure
    {
        ...
        /// </summary>
        public SymbolReference<DataName> RecordKey { get; set; }
        ...
        /// </summary>
        public IList<SymbolReference<DataName>> AlternateRecordKeys { get; set; }
        ...
        /// </summary>        
        public IList<bool> AlternateRecordKeysAllowDuplicates { get; set; }
        ...
        /// For any other type of file processing (including the processing of dynamic calls at file creation time through a COBOL runtime subroutine), every PASSWORD data item for the file must contain a valid password before the file can be successfully opened, regardless of whether all paths to the data are used in this object program.
        /// </summary>
        public IList<SymbolReference<DataName>> AlternateRecordKeysPasswords { get; set; }
    }
    ...
    public class RelativeFileStructure : FileStructure
    {
        ...
        /// </summary>
        public SymbolReference<DataName> RelativeKey { get; set; }
