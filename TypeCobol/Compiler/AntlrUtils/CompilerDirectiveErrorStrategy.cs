...
{
    /// <summary>
    /// Customized strategy in case of syntax error for the compiler directive parser
    /// </summary>
    public class CompilerDirectiveErrorStrategy : DefaultErrorStrategy
    {
        /// <summary>
        ...
        /// eat the next compiler directive / statement starting keyword 
        /// </summary>
