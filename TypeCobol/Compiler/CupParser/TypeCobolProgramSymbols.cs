...
public class TypeCobolProgramSymbols {
  ...
  public const int FunctionDeclarationEnd = 131;
  ...
  public const int GlobalStorageSectionHeader = 133;
  ...
  public const int ProcedureStyleCall = 132;
