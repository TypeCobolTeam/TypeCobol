...
namespace TypeCobol.LanguageServer
{
    ...
    public class Workspace
    {
        ...
        private readonly DataLayoutProcessor _dataLayoutProcessor;
        ...
        public Workspace(string rootDirectoryFullName, string workspaceName, System.Collections.Concurrent.ConcurrentQueue<MessageActionWrapper> messagesActionsQueue, Action<string> logger)
        {
            ...
            _dataLayoutProcessor = new DataLayoutProcessor();
        }
        ...
        internal void BindFileCompilerSourceTextDocument(DocumentContext docContext, string sourceText, LsrTestingOptions lsrOptions)
        {
            ...
            {
                fileCompiler.CompileOnce(lsrOptions.ExecutionStep(fileCompiler.CompilerOptions.ExecToStep), fileCompiler.CompilerOptions.HaltOnMissingCopy); //Let's parse file for the first time after opening. 
            }
        }
