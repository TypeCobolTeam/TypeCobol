...
controlCblCompilerStatement:
                       ...
                       controlCblOption+
                       ({IsNextTokenOnTheSameLine()}? PeriodSeparator)?;
...
ejectCompilerStatement:
                          EJECT ({IsNextTokenOnTheSameLine()}? PeriodSeparator)?;
...
skipCompilerStatement:
                         (SKIP1 | SKIP2 | SKIP3) ({false}? PeriodSeparator)?;				
...
titleCompilerStatement:
                          TITLE (AlphanumericLiteral | NationalLiteral | DBCSLiteral) ({IsNextTokenOnTheSameLine()}? PeriodSeparator)?;
