...
namespace TypeCobol.Test.Misc {
    ...
    public class TestPictureParsing {
        ...
        public void Check_PictureToType() {
            ...
            TestConversion("XA",            DataType.Alphanumeric);
            TestConversion("X9",            DataType.Alphanumeric);
            ...
            TestConversion("N",             DataType.DBCS);
            ...
            // the following syntax are recognized, although wrong
            // this method tries to detect intent, it's not its job to detect syntax errors
            TestConversion("UX",   DataType.NumericEdited, new char[] {'U'});
            TestConversion("UN",   DataType.NumericEdited, new char[] {'U'});
            TestConversion("UA",   DataType.NumericEdited,    new char[] {'U'});
