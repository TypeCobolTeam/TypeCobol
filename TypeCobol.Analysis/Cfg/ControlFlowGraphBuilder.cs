...
namespace TypeCobol.Analysis.Cfg
{
    ...
    public class ControlFlowGraphBuilder<D> : ProgramClassBuilderNodeListener
    {
        ...
        private bool ResolvePendingPERFORMProcedure(PerformProcedure p, BasicBlockForNodeGroup group)
        {
            ...
            //Now Clone the Graph.
            if (!RelocateBasicBlockForNodeGroupGraph(group, clonedBlockIndexMap))
            {
        ...
        /// </summary>
        private bool RelocateBasicBlockForNodeGroupGraph(BasicBlockForNodeGroup group, Dictionary<int, int> clonedBlockIndexMap)
        {
