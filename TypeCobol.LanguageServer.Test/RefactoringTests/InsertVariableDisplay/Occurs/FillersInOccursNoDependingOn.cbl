...
refactoring.source=
      ...
      *<DBG>InsertVariableDisplay 1959/09/18 11:09 TESTUSER
      D77 Idx-ed1e4833-1 PIC 9(4) COMP.
      D77 Idx-ed1e4833-2 PIC 9(3) COMP.
      D77 Idx-ed1e4833-3 PIC 9(2) COMP.
      *</DBG>

       PROCEDURE DIVISION.
      *<DBG>InsertVariableDisplay 1959/09/18 11:09 TESTUSER
      D    PERFORM VARYING Idx-ed1e4833-1 FROM 1 BY 1 UNTIL
      D    Idx-ed1e4833-1 > 1000
      D      PERFORM VARYING Idx-ed1e4833-2 FROM 1 BY 1 UNTIL
      D      Idx-ed1e4833-2 > 200
      D        PERFORM VARYING Idx-ed1e4833-3 FROM 1 BY 1 UNTIL
      D        Idx-ed1e4833-3 > 30
      D          DISPLAY '        FILLER (' Idx-ed1e4833-1 ' '
      D          Idx-ed1e4833-2 ' ' Idx-ed1e4833-3 ') (2:20) <'
      D          table-level2-1 (Idx-ed1e4833-1 Idx-ed1e4833-2
      D          Idx-ed1e4833-3) (2:20) '>'
      D        END-PERFORM
      D      END-PERFORM
      D    END-PERFORM
      *</DBG>
