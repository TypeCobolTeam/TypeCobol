...
namespace TypeCobol.Codegen.Generators
{
    ...
    public class LinearNodeSourceCodeMapper : NodeVisitor
    {
        ...
        public enum Phase
        {
            ...
            FunctionDeclaration,
            /// <summary>
            /// The Phase that attach Nodes Generated by a Factory, to the first parent
            /// having a position.
            /// </summary>
        ...
        private bool ProcessFactoryGeneratedNodeAttachment(Node node)
        {
            ...
            {   //This Node has been generated by a factory
                ...
                if (lastNode is TypeCobol.Compiler.Nodes.End)
                    //This a a End Node ==> add before the last end node
        ...
        /// <summary>
        /// Given a node this gives its first parent which has a position.
        /// </summary>
        ...
        /// <param name="lastNode">The last node of the line number</param>
        /// <returns></returns>
