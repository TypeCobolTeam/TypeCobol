      ...
      * "4"@(60:12>60:67): [30:1] Semantic error: Cannot write Alphanumeric to strongly typed variable InternalRef:INTERNAL-REF (use UNSAFE keyword for that)
      * "4"@(61:12>61:67): [30:1] Semantic error: Cannot write INTERNAL-REF to strongly typed variable ExternalRef:EXTERNAL-REF (use UNSAFE keyword for that)
