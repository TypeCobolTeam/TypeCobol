      ...
      *_________________________________________________________________
       IDENTIFICATION DIVISION.
       PROGRAM-ID. c49a4761-DoesNothing.
       PROCEDURE DIVISION
           .
           DISPLAY 'I DO NOTHING'
           .
       END PROGRAM c49a4761-DoesNothing.
      *
      *DECLARE FUNCTION ReturnsZero PRIVATE
      *      RETURNING result PIC 9(04).
      *_________________________________________________________________
       IDENTIFICATION DIVISION.
       PROGRAM-ID. e61a1c43-ReturnsZero.
       DATA DIVISION.
       LINKAGE SECTION.
       01 result PIC 9(04).
       PROCEDURE DIVISION
           ...
           MOVE 0 TO result.
           .
       END PROGRAM e61a1c43-ReturnsZero.
      *
      *DECLARE FUNCTION DoesNothing PRIVATE
      *      INPUT x PIC 9(04).
      *_________________________________________________________________
       IDENTIFICATION DIVISION.
       PROGRAM-ID. cd51a7fd-DoesNothing.
       DATA DIVISION.
       LINKAGE SECTION.
       01 x PIC 9(04).
       PROCEDURE DIVISION
           ...
           .
       END PROGRAM cd51a7fd-DoesNothing.
      *
      *DECLARE FUNCTION StrangelyReturnsItsInput PRIVATE
      *      INPUT     x      PIC 9(04) comp-3
      *      RETURNING result PIC 9(04) comp
      ...
      *_________________________________________________________________
       IDENTIFICATION DIVISION.
       PROGRAM-ID. c498f2f1-StrangelyReturnsItsInput.
       DATA DIVISION.
       LINKAGE SECTION.
       ...
       PROCEDURE DIVISION
           ...
           ELSE
             MOVE x TO result
           END-IF.
       END PROGRAM c498f2f1-StrangelyReturnsItsInput.
      *
      *declare function UseACopy private
      *         input  x pic X.
      *_________________________________________________________________
       IDENTIFICATION DIVISION.
       PROGRAM-ID. e7b552c0-UseACopy.
       data division.
