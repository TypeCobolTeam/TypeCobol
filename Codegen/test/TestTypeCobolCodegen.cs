...
namespace TypeCobol.Codegen
{
    ...
    public class TestTypeCobolCodegen
    {
        ...
        [TestCategory("Codegen")]
        [TestProperty("Time", "fast")]
        public void ParseFunctionsDeclarationWithExec()
        {
        ...
        [TestCategory("Codegen")]
        [TestProperty("Time", "fast")]
        public void ParseProcedureWithExec_PrivateOnly()
        {
        ...
        [TestCategory("Codegen")]
        [TestProperty("Time", "fast")]
        public void ParseProcedureWithExec_PublicOnly()
        {
        ...
        [TestCategory("Codegen")]
        [TestProperty("Time", "fast")]
        public void ParseProcedureWithExec_PublicPrivate()
        {
        ...
        public void TypedefBodyInsideCopy()
        {
            ...
            CodegenTestUtils.ParseGenerateCompare(Path.Combine("TypeCobol", "TypedefCopys", "TypedefBodyInsideCopy") + ".rdz.tcbl", false, null, new List<string>() {copies});
        }
        ...
        [TestCategory("Codegen")]
        [TestProperty("Time", "fast")]
        public void GlobalStorageWithTypedefAndIndex()
        {
        ...
        [TestCategory("Codegen")]
        [TestProperty("Time", "fast")]
        public void GlobalStorageWithUsingTypeDef()
        {
        ...
        [TestCategory("Codegen")]
        [TestProperty("Time", "fast")]
        public void GlobalStorageCopyConfigSectionOnly()
        {
        ...
        /*
         * TODO Missing tests
         * These files are present in resources\input\TypeCobol but are not used :
         * - GenEndProgram.rdz.tcbl
         * - GenEndStackedProgram.rdz.tcbl
         * - TypeCurrency.tcbl
         * - TypeDate.tcbl
         */
